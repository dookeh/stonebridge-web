...
const Dockside = () => {
  return (
    <div className="bg-[#0b0e14] text-zinc-300 min-h-screen font-ui selection:bg-[#c2410c]">
      <Navbar />

      {/* FACTION HEADER */}
      <div className="relative h-[60vh] flex items-end bg-[#05070a]">
        {/* Background Overlay - Navy and Rust Gradient */}
        <div className="absolute inset-0 z-0 bg-gradient-to-t from-[#0b0e14] via-[#1e293b]/20 to-transparent" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pb-20">
          <Link to="/" className="flex items-center gap-2 text-zinc-500 hover:text-[#c2410c] transition-colors mb-8 uppercase text-[10px] font-bold tracking-widest">
            <ChevronLeft size={14} /> Back to Sector Map
          </Link>
          
          <div className="flex flex-col md:flex-row items-center gap-10">
            {/* The Logo for Dockside */}
            <img 
              src="/docksidelogo.png" 
              alt="Dockside Order" 
              className="w-48 h-48 object-contain drop-shadow-[0_0_30px_rgba(194,65,12,0.3)]" 
            />
            <div className="text-center md:text-left">
              <h1 className="font-header text-6xl md:text-8xl uppercase italic leading-none mb-4 text-white">
                Dockside <span className="text-[#c2410c]">Order</span>
              </h1>
              <p className="font-header text-[#c2410c] text-2xl tracking-[0.3em] uppercase italic">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 border-l-4 border-[#c2410c] bg-orange-950/5 flex items-start gap-4">
              <ShieldAlert className="text-[#c2410c] shrink-0" size={20} />
              <div>
                <p className="font-typewriter text-[#c2410c] uppercase text-xs font-bold mb-2">Notice: Civilian Presence High</p>
          ...
          <div className="lg:col-span-2 space-y-12">
            <section>
              ...
              <div className="space-y-6 font-typewriter text-zinc-400 text-lg leading-relaxed">
                ...
                <p>
                  They are the backbone of the city's working class—smuggling contraband like <span className="text-[#c2410c] font-bold">Brown Sugar</span> under the noses of the SMC, while maintaining a strict code of silence that the police have failed to break for decades.
                </p>
              </div>
            </section>
      ...
      <footer className="py-20 text-center opacity-30">
        <p className="font-ui text-[10px] tracking-widest uppercase">End of Dossier // SMC-SECURE-FILE-044</p>
      </footer>
    </div>
  );
};
...
const StatRow = ({ label, value }) => (
  <div className="flex justify-between items-center py-3 border-b border-white/5 group/row">
    ...
    <span className="text-[11px] uppercase tracking-widest text-[#c2410c] font-black text-right ml-4">
      {value}
    </span>
  </div>
);
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="p-6 bg-zinc-900/20 border border-white/5 group hover:border-[#c2410c]/50 transition-colors">
